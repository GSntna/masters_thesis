...
def _process_parks(gdf:gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    ...
    :rtype: gpd.GeoDataFrame
    '''
    gdf = gdf.rename(columns={'leisure': 'category'})  # raname col
    gdf['subcategory'] = 'park'  # add subcategory column
...
def process_osm(gdf:gpd.GeoDataFrame, category:str) -> gpd.GeoDataFrame:
    ...
    are: "parks", "schools", "public_transport", "police_stations" and "hospitals"
